...
export default function ContactForm() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_hze3adc', 'template_qzxrd6r', formRef.current, 'kw9RO1BExRVPZKruz')
            .then((result) => {
            ...
            >
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <input className="border bg-gray-900 border-gray-700 rounded-md px-3 py-2" type="text" name="name" id="name" placeholder="Renata Godoy" />
                    </div>
                    <div className="flex flex-col gap-2">
                        <label htmlFor="email" className="text-sm font-medium" >Email</label>
                        <input
                            placeholder="devrenatagodoy@gmail.com"
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <textarea placeholder="Ola, gostaria de..." className="border  bg-gray-900 border-gray-700 rounded-md px-3 py-2" name="message" id="message" cols={30} rows={3}></textarea>
                    </div>
